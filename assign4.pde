    ...
    if(enemyTeam1 == true)
    {
        ...
        {        
            ...
            if(deadOrNotT1[i] == false)
            {
                ...
                int enemyDistY = y6-yPos;        
                int team1Distance = (int)sqrt(enemyDistX*enemyDistX+enemyDistY*enemyDistY);
                        
                if(team1Distance <= enemyImg.width*0.5f+fighterImg.width*0.5f)
                { 
                    deadOrNotT1[i] = true;
                    x4 = x4-20;                        
        ...
        for(int b = 0 ; b < bX.length; b++)
        {
            for(int e = 0 ; e < enemyTeam1Xs.length ; e++){
                ...
                float dist = sqrt( dx*dx + dy*dy );
                    ...
                    if( dist < shootImg.width*0.5+enemyImg.width*0.5)
                    {
                       deadOrNotT1[e] = true;
                       fx = xPos;
                       fy = yPos;
      ...
      if(enemyTeam2 == true)
      {
        ...
        for(int i = 0;i < 5; i++){          
            ...
            if(deadOrNotT2[i] == false){
                      ...
                      if(enemyTeam2Dist <= enemyImg.width*0.5f+fighterImg.width*0.5f){
                          deadOrNotT2[i] = true;
                          x4 = x4-20;
                          //flame pic position
                          fx = xPos;
